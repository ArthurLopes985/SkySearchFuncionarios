...
rel='stylesheet'>
        <link rel="stylesheet" href="<%= request.getContextPath() %>/Cadastrar.css">
    </head>
    <body>
    <%
        ...
        <form action="FuncionariosController" method="POST" accept-charset="UTF-8">
            ...
            <div class="checkbox-box">
                <input type="checkbox" name="periculosidade" id="periculosidade" value="true"> <label for="periculosidade">Trabalho com alto grau de preiculosidade? (Adicional de Periculosidade)</label>
            </div>
            <div class="checkbox-box">
                <input type="checkbox" name="noturno" id="noturno" value="true"> <label for="noturno">Trabalho será noturno? (Adicional Noturno)</label>
            </div>
            <br>
            <label>
                    Endereço:
            ...
            <div class="input-box"> 
                <input placeholder="CEP" type="text" name="cepnovo" value="<%= request.getParameter("cepnovo") != null ? request.getParameter("cepnovo") : "" %>" required>
            </div>
            <div class="input-box"> 
                <input placeholder="Rua" type="text" name="ruanovo" value="<%= request.getParameter("ruanovo") != null ? request.getParameter("ruanovo") : "" %>" required>
            </div>
            <div class="input-box"> 
                <input placeholder="Bairro" type="text" name="bairronovo" value="<%= request.getParameter("bairronovo") != null ? request.getParameter("bairronovo") : "" %>" required>
            </div>
            <div class="input-box"> 
                <input placeholder="Cidade" type="text" name="cidadenovo" value="<%= request.getParameter("cidadenovo") != null ? request.getParameter("cidadenovo") : "" %>" required>
            </div>
            <br>
            <label>
